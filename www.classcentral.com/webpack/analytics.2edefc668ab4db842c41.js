  ...
  (e.n = function (t) {
    ...
    (function () {
      ...
      var i = class {
        constructor(n) {
          (this.config = ((t) =>
            !!(t.url && t.indexes && t.indexes.monthly && t.indexes.weekly) &&
            t)(n)),
            (this.ads = []),
            this.config &&
              (n.trackImpressions,
              t("data-track-click", this.handleEvent.bind(this, "click"))),
            t("data-track-ga", this.handleEvent.bind(this, "ga"));
        }
        track() {}
        trackGA(t) {
          f(
        ...
        handleEvent(t, n) {
          ...
          try {
            if ("ga" === t)
              return (
                n.dataset.trackGa && (e = JSON.parse(n.dataset.trackGa)), f(e)
              );
          } catch (t) {}
        }
      };
